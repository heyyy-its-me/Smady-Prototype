...
export const agents: AgentInfo[] = [
  ...
  { id: 'leads', icon: Users, title: 'Lead Management', short: 'Prospects', desc: 'Find and qualify the companies worth knowing.', tone: 'blue', status: 'Ready' },
  ...
  { id: 'crm', icon: BarChart3, title: 'CRM & Analytics', short: 'Analytics', desc: 'Keep the story of every deal clear and useful.', tone: 'cyan', status: 'Ready' },
];
